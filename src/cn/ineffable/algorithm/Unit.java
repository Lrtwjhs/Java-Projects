...
/**
 * 运算单元
 * 将可运算的运算符、左右符号、起止符并称为广义运算符
 */

public class Unit {

    enum Type{ADD, SUBSTRACT, SIN, COS, TAN, LN, LOG, SQRT, MULTIPLY, DIVIDE, EE, POSITIVE, NEGATIVE, POEWR, FACTORIAL, LEFT_BRACKET, RIGHT_BRACKET, START_STOP_SIGN, OPERAND};
    ...
    public boolean isBinary() {
        return  type == Type.ADD || type == Type.SUBSTRACT || type == Type.MULTIPLY || type == Type.DIVIDE || type == Type.EE || type == Type.POEWR;
    }
